...
class ProjectDetailActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val assetList= intent.getSerializableExtra("listofass") as List<ProjectAssetNotUri>
        val projectAss = intent.getSerializableExtra("projectAss") as ProjectAssetNotUri
